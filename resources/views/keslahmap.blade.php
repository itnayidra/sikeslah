...
<main id="main" class="main">
    ...
    <div id="searchModal" class="card" style="width: 275px; height:100px;">
        <div class="card-body">
            ...
            <button type="button" id="cariLokasi" class="btn btn-success" style="position: absolute; left:210px;">Cari</button>
