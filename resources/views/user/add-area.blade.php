                        ...
                        <div class="col-md-4 mb-3 px-3">
                            <form id="landForm" action="{{ route('store_area') }}" method="post"  style="font-family: 'Nunito'; font-size: 14px; background-color: #f9f9f9; border-radius: 8px; padding: 10px 20px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1);">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="kedalaman_tanah" name="kedalaman_tanah" placeholder="Masukkan nilai kedalaman tanah (cm)">
                                    {{-- <div class="col-sm-10">
                                ...
                                {{-- KTK-liat --}}
                                <div class="form-group mb-3">
                                    <label for="ktk" class="form-label">KTK Tanah</label>
                                    <input type="number" step="0.01" class="form-control" id="ktk" name="ktk" placeholder="Masukkan nilai KTK tanah (cmol/kg)">
                                     @error('ktk')
                                        <small class="text-danger">{{$message}}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="card-footer mt-4 text-end">
                                    ...
                                    <a href="{{ route('user.dashboard') }}" class="btn btn-secondary" id="btn_cancel_polygon">Batal</a>
                                </div>
                            </form>
                        </div>
                    </div>
