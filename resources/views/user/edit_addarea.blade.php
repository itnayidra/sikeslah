                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3 px-3">
                            <form id="formUpdate" action="{{ route('user.updateaddarea', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data" style="font-family: 'Nunito'; font-size: 14px; background-color: #f9f9f9; border-radius: 8px; padding: 10px 20px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1);">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="card-footer mt-4 text-end">
                                    ...
                                    <a href="{{ route('user.dashboard') }}" class="btn btn-warning"  id="btn_cancel_polygon">Batal</a>
                                </div>
                            </form>
                        </div>
                    </div>
...
@section('scripts')
<script type="module" src="{{ asset('/build/assets/edit_evaluasipage-D984gYnN.js') }}"></script>
<script>
