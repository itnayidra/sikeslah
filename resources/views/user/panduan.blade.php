    ...
    <div class="container-fluid container-xl position-relative align-items-center justify-content-between">
        <div class="row justify-content-center mt-5" style="padding: 15px;">
                ...
                <div class="row mb-2">
                    ...
                    <p style="color:white; margin-top: 15px">
                        ...
                        <ul style="list-style:none; line-height: 2;">
                            ...
                            <li>
                                <i class="fa-brands fa-readme" style="color:white"></i>
                                <a href="#panduanvideo" class="active-link"><span class="ms-2">Video Panduan</span></a>        
                            </li>
                        </ul>
                        <br>
                    </p>
            ...
            <div class="col-lg-8 col-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div>
                                    <ol>
                                        <li>
                                            <p style="text-align: justify">Masuk ke <a href="{{ route('user.lbsmap') }}" style="color:blue"> Peta Lahan Sawah</a></p>
                                        </li>
                                        <li>
                                            <p style="text-align: justify">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div>
                                    <ol>
                                        <li>
                                            <p style="text-align: justify">Masuk ke <a href="{{ route('user.keslahmap') }}" style="color:blue"> Cek Kesesuaian Lahan</a></p>
                                        </li>
                                        <li>
                                            <p style="text-align: justify">
                ...
                <section id="panduannilailahan" class="panduannilailahan" style="padding-top:40px; padding-bottom:0">
                    <div class="card">
                        <div class="card-header">
                ...
                <section id="panduanvideo" class="panduanvideo" style="padding-top:40px;">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-center">Video Panduan Penggunaan</h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <p style="text-align: justify">
                                        Yuk, simak video panduan berikut ini. 
                                    </p>
                                    <div class="video-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; background: #000;">
                                        <iframe src="https://www.youtube.com/embed/L4JqQh3NzAg"frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
