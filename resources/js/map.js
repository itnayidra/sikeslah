...
function adjustTransparency(rgba, alpha) {
    const [r, g, b] = rgba.match(/\d+/g); // Extract RGB values from fill color
           ...
           // Contoh penggunaan dalam kondisi validasi fitur
            if (!features.length) {
                ...
                Swal.fire({
                    toast: true,
                    icon: 'warning',
                    title: 'Lahan untuk tanaman ' + layerLabel + ' berdasarkan kondisi yang Anda masukan tidak ditemukan.',
                    position: 'center',
            ...
            vectorLayerQuery1 = new VectorLayer({
                ...
                style: function (feature) {
                    ...
                    const strokeColor = adjustTransparency(fillColor, 0.8);
